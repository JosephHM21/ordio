...
export default function Page() {
  return (
    <div style={{fontFamily:"Inter,system-ui,sans-serif",maxWidth:600}}>
      <h1 style={{fontSize:22,fontWeight:900,color:"#111",margin:"0 0 6px"}}>⭐ Reseñas</h1>
      <p style={{fontSize:14,color:"#888",margin:"0 0 32px"}}>Calificaciones y opiniones de tus clientes.</p>
      <div style={{background:"#fff",borderRadius:16,border:"1.5px solid #F0F0F0",padding:"48px 32px",textAlign:"center"}}>
        ...
        <p style={{fontSize:14,color:"#888",margin:"0 0 24px",lineHeight:1.6}}>Calificaciones y opiniones de tus clientes.<br/>Esta sección estará disponible en la próxima actualización.</p>
